...
function createSequenceControls(json, attributes) {
    ...
    var SequenceControl = L.Control.extend({
        ...
        onAdd: function () {
            ...
            //add skip buttons
            container.insertAdjacentHTML('beforeend', '<button class="step" id="reverse" title="Reverse"><img src="assets/reverse.png"></button>');
            container.insertAdjacentHTML('beforeend', '<button class="step" id="forward" title="Forward"><img src="assets/forward.png"></button>');
...
function getData() {
    fetch('assets/borderApprehensionData.geojson')
...
function getBorderWall() {
    fetch('assets/border_fence_map.geojson')
        .then(function (response) {
            return response.json();
        })
        .then(function (json) {
